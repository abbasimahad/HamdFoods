...
export const appNavigation: readonly NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      active("Material Issues", routes.future.production.materialIssues, "production.view"),
      active(
  ...
  },
  {
    ...
    children: [
      ...
      active("Receivables", routes.future.accounting.receivables, "accounting.view"),
      active("Payables", routes.future.accounting.payables, "accounting.view"),
