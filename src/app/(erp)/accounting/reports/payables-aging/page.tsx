...
import { payableAging, reportAsOf } from "@/server/accounting/financial-reporting";
...
export default async function Page({ searchParams }: { searchParams: Promise<{ asOf?: string }> }) {
  ...
  const report = await payableAging(asOf);
  return (
    <ResponsiveContainer>
      <PageHeader
        title="Accounts Payable Aging"
        description="Open payable ledger items, net of posted allocations as of the selected date."
      />
